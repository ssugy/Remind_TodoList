...
class ClassifierWithModel(context: Context) {
    ...
    var modelInputHeight:kotlin.Int = 0
    var modelInputChannel:kotlin.Int = 0
    ...
    fun getModelInputSize(): Size? {
        return if (!isInitialized) Size(0, 0) else Size(modelInputWidth, modelInputHeight)
    }
